...
func findRepliesTo(ctx context.Context, issueID string, store storage.DependencyQueryStore) string {
...
func findReplies(ctx context.Context, issueID string, store storage.DependencyReader) []*types.Issue {
